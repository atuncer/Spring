...
class TestShopService {
	...
	void createShop() {
		...
		product1.setUrl("https://i.hizliresim.com/2b2d3vq.jpg");
		
		Product product2=new Product();
		product2.setName("IPad 9");
		product2.setPrice(3900);
		product2.setUrl("https://i.hizliresim.com/j4hqk24.png");

		
		Product product3=new Product();
		product3.setName("Lenovo ThinkPad E14");
		product3.setPrice(15200);
		product3.setUrl("https://i.hizliresim.com/aa5nmj7.png");
